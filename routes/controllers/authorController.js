...
module.exports.getAuthors=async(req,res)=>{
        ...
        await Author.findAndCountAll({offset:req.headers.offset,limit:req.headers.limit,distinct:true,include:[Article],order:[[req.headers.orderfield?req.headers.orderfield:'name',req.headers.ordertype?req.headers.ordertype:'ASC']]}).then((authors)=>{
